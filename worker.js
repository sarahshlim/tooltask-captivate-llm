...
export default {
  async fetch(request, env) {
    ...
    */
    ...
    const systemPrompt =
      "You are a precise and supportive evaluator of student writing. " +
      "Judge the learner response using the provided learning objective and criteria. " +
      "Be specific, fair, and instructional. " +
    ...
    const userPrompt =
      ...
      `Learner response:\n${responseText}\n\n` +
      "Evaluate whether the learner correctly explains if the objective is measurable.\n" +
      "Use the criteria to decide what is met.\n" +
      "Be concrete and reference the criteria in your explanation.\n" +
...
function isAllowedOrigin(origin) {
  ...
  if (origin === "https://sarahshlim.github.io") return origin;
